...
/*!******************************************************************!*\
  !*** ./node_modules/three/examples/jsm/animation/CCDIKSolver.js ***!
  \******************************************************************/
/*! exports provided: CCDIKSolver, CCDIKHelper */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CCDIKSolver", function() { return CCDIKSolver; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CCDIKHelper", function() { return CCDIKHelper; });
...
/*!*************************************************************************!*\
  !*** ./node_modules/three/examples/jsm/animation/MMDAnimationHelper.js ***!
  \*************************************************************************/
/*! exports provided: MMDAnimationHelper */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MMDAnimationHelper", function() { return MMDAnimationHelper; });
/* harmony import */ var three__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! three */ "./node_modules/three/build/three.module.js");
/* harmony import */ var _animation_CCDIKSolver_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../animation/CCDIKSolver.js */ "./node_modules/three/examples/jsm/animation/CCDIKSolver.js");
/* harmony import */ var _animation_MMDPhysics_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../animation/MMDPhysics.js */ "./node_modules/three/examples/jsm/animation/MMDPhysics.js");
...
class MMDAnimationHelper {
	...
	constructor( params = {} ) {
		...
		this.camera = null;
		this.cameraTarget = new three__WEBPACK_IMPORTED_MODULE_0__["Object3D"]();
	...
	_setupMeshAnimation( mesh, animation ) {
		...
		if ( animation !== undefined ) {
			...
			objects.mixer = new three__WEBPACK_IMPORTED_MODULE_0__["AnimationMixer"]( mesh );
	...
	_setupCameraAnimation( camera, animation ) {
		...
		objects.mixer = new three__WEBPACK_IMPORTED_MODULE_0__["AnimationMixer"]( camera );
	...
	_createCCDIKSolver( mesh ) {
		...
		if ( _animation_CCDIKSolver_js__WEBPACK_IMPORTED_MODULE_1__["CCDIKSolver"] === undefined ) {

			throw new Error( 'THREE.MMDAnimationHelper: Import CCDIKSolver.' );

		}

		return new _animation_CCDIKSolver_js__WEBPACK_IMPORTED_MODULE_1__["CCDIKSolver"]( mesh, mesh.geometry.userData.MMD.iks );

	}

	_createMMDPhysics( mesh, params ) {

		if ( _animation_MMDPhysics_js__WEBPACK_IMPORTED_MODULE_2__["MMDPhysics"] === undefined ) {

			throw new Error( 'THREE.MMDPhysics: Import MMDPhysics.' );

		}

		return new _animation_MMDPhysics_js__WEBPACK_IMPORTED_MODULE_2__["MMDPhysics"](
			mesh,
...
function getQuaternion() {
	...
	if ( _quaternionIndex >= _quaternions.length ) {
		...
		_quaternions.push( new three__WEBPACK_IMPORTED_MODULE_0__["Quaternion"]() );
...
/*!*****************************************************************!*\
  !*** ./node_modules/three/examples/jsm/animation/MMDPhysics.js ***!
  \*****************************************************************/
/*! exports provided: MMDPhysics */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MMDPhysics", function() { return MMDPhysics; });
/* harmony import */ var three__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! three */ "./node_modules/three/build/three.module.js");
...
class MMDPhysics {
	...
	constructor( mesh, rigidBodyParams, constraintParams = [], params = {} ) {
		...
		this.gravity = new three__WEBPACK_IMPORTED_MODULE_0__["Vector3"]( 0, - 9.8 * 10, 0 );
...
class RigidBody {
	...
	_init() {
		...
		const bone = ( params.boneIndex === - 1 )
			? new three__WEBPACK_IMPORTED_MODULE_0__["Bone"]()
...
const _matrixWorldInv = new three__WEBPACK_IMPORTED_MODULE_0__["Matrix4"]();

class MMDPhysicsHelper extends three__WEBPACK_IMPORTED_MODULE_0__["Object3D"] {
	...
	_init() {
		...
		function createGeometry( param ) {
			...
			switch ( param.shapeType ) {
				...
				case 0:
					return new three__WEBPACK_IMPORTED_MODULE_0__["SphereGeometry"]( param.width, 16, 8 );

				case 1:
					return new three__WEBPACK_IMPORTED_MODULE_0__["BoxGeometry"]( param.width * 2, param.height * 2, param.depth * 2, 8, 8, 8 );

				case 2:
					return new three__WEBPACK_IMPORTED_MODULE_0__["CapsuleGeometry"]( param.width, param.height, 8, 16 );
		...
		for ( var i = 0, il = bodies.length; i < il; i ++ ) {
			...
			this.add( new three__WEBPACK_IMPORTED_MODULE_0__["Mesh"]( createGeometry( param ), this.materials[ param.type ] ) );
