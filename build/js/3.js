			...
			for ( let i = 0, il = geometries.length; i < il; i ++ ) {
				...
				if ( primitive.mode === WEBGL_CONSTANTS.TRIANGLES ||
					...
					if ( primitive.mode === WEBGL_CONSTANTS.TRIANGLE_STRIP ) {
						...
						mesh.geometry = Object(_utils_BufferGeometryUtils_js__WEBPACK_IMPORTED_MODULE_1__["toTrianglesDrawMode"])( mesh.geometry, three__WEBPACK_IMPORTED_MODULE_0__["TriangleStripDrawMode"] );

					} else if ( primitive.mode === WEBGL_CONSTANTS.TRIANGLE_FAN ) {

						mesh.geometry = Object(_utils_BufferGeometryUtils_js__WEBPACK_IMPORTED_MODULE_1__["toTrianglesDrawMode"])( mesh.geometry, three__WEBPACK_IMPORTED_MODULE_0__["TriangleFanDrawMode"] );
...
/*!**********************************************************************!*\
  !*** ./node_modules/three/examples/jsm/utils/BufferGeometryUtils.js ***!
  \**********************************************************************/
/*! exports provided: deepCloneAttribute, deinterleaveAttribute, deinterleaveGeometry, computeMikkTSpaceTangents, mergeGeometries, mergeBufferGeometries, mergeAttributes, mergeBufferAttributes, interleaveAttributes, estimateBytesUsed, mergeVertices, toTrianglesDrawMode, computeMorphedAttributes, mergeGroups, toCreasedNormals */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "deepCloneAttribute", function() { return deepCloneAttribute; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "deinterleaveAttribute", function() { return deinterleaveAttribute; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "deinterleaveGeometry", function() { return deinterleaveGeometry; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "computeMikkTSpaceTangents", function() { return computeMikkTSpaceTangents; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "mergeGeometries", function() { return mergeGeometries; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "mergeBufferGeometries", function() { return mergeBufferGeometries; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "mergeAttributes", function() { return mergeAttributes; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "mergeBufferAttributes", function() { return mergeBufferAttributes; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "interleaveAttributes", function() { return interleaveAttributes; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "estimateBytesUsed", function() { return estimateBytesUsed; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "mergeVertices", function() { return mergeVertices; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "toTrianglesDrawMode", function() { return toTrianglesDrawMode; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "computeMorphedAttributes", function() { return computeMorphedAttributes; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "mergeGroups", function() { return mergeGroups; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "toCreasedNormals", function() { return toCreasedNormals; });
/* harmony import */ var three__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! three */ "./node_modules/three/build/three.module.js");
