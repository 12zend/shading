/* Atomic Movie frame publication and bounded GPU target reuse, owned by scratch-render. */
const frameMethods = {
    beginFrame () {
        const gl = this.gl;
        ...
        // Movie draws use _texture/_framebuffer, while stage drawing asks getTexture(). Keep the completed
        // previous frame visible until the staged drawing texture is committed.
